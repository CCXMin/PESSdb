...
<body>
	<div class="container" style="width: 80%">
		<!-- Use php require_once expression to inculde header image and navigation bar from nav.php -->
		...
		<form action="dispatch.php" method="post" onsubmit="myFunction()">
			...
			<div class="form-group row">
				...
				<div class="col-lg-8">
					<input type="text" name="callerName" class="form-control" id="callerName" pattern="[a-zA-Z ]+">

				</div>
			</div>

			<!-- Row for Contact No label and texbox input -->
			<div class="form-group row">
				<label for="contactNo" class="col-lg-4 col-form-label">Contact Number (Required)</label>
				<div class="col-lg-8">
					<input type="text" name="contactNo" class="form-control" id="contactNo" required pattern="[0-9]{8}">
				</div>
			</div>

			<!-- Row for Location of Incident label and texbox input -->
			<div class="form-group row">
