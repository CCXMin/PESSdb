        ...
        <div class="container" style="width: 80%">
            ...
            <section style="margin-top: 20px">
                ...
                <form action="update.php" method="post">
                    ...
                    echo "<label for='patrolCarId' class='col-lg-4 col-form-label'>Patrol Car Number</label>";
                    ...
                    echo "<div class='form-group row'>";
                    echo "<label for='carNo' class='col-lg-4 col-form-label'>Patrol Car Status</label>";
                    echo "<div class='col-lg-8'>";
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8">
                            <input class="btn btn-primary" type="submit" name="btnUpdate" value="Update" button onclick="myFunction()">
                            <script>
                            function myFunction() {
